...
async def test_smoke_get_user(test_data: dict, users_api: UserApi, get_session_customer_user_response: ClientResponse):
    """Smoke test to get user

    :param test_data: dict with current test set data
    :param get_session_customer_user_response: get user response to check
    """
    soft_check_response_status_code(get_session_customer_user_response, codes.ok)
