...
async def session_product(products_api: ProductApi, session_manager_user: User, http_task_group: TaskGroup) -> Product:
    ...
    create_product_response = await products_api.create(product, auth=UserApi.get_auth(session_manager_user))
    ...
    http_task_group.create_task(products_api.delete(product.id, auth=UserApi.get_auth(session_manager_user)))


@pytest.fixture(scope="session")
async def session_get_product_response(products_api: ProductApi, session_customer_user: User,
    ...
    """
    return await products_api.get(session_product.id, auth=UserApi.get_auth(session_customer_user))


@pytest.fixture(scope="session")
async def session_get_all_products_response(products_api: ProductApi, session_customer_user: User) -> ClientResponse:
    ...
    """
    return await products_api.get_all(auth=UserApi.get_auth(session_customer_user))


@pytest.fixture(scope="session")
async def session_update_product_response(products_api: ProductApi, session_manager_user: User,
                                          session_product: Product) -> ClientResponse:
    ...
    return await products_api.update(session_product.id, product_attributes_to_update,
                                     auth=UserApi.get_auth(session_manager_user))


@pytest.fixture
async def created_product_response(products_api: ProductApi, generated_product: Product,
    ...
    """
    create_product_response = await products_api.create(generated_product, auth=UserApi.get_auth(session_manager_user))
    ...
    if create_product_response.ok:
        ...
        http_task_group.create_task(
            products_api.delete(created_product_id, auth=UserApi.get_auth(session_manager_user)))
...
@pytest.fixture
async def deleted_product_response(products_api: ProductApi, generated_product: Product,
    ...
    return await products_api.delete(create_product_id, auth=UserApi.get_auth(session_manager_user))
