"""Data Driven Unit Test to check DELETE /api/user/{user_id} endpoint"""
import pytest
...
def test_ddt_delete_valid_user(test_data: dict, application_client: Flask):
    """Test DELETE /api/user/{user_id} endpoint
