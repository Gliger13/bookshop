"""Data Driven Unit Test to check GET /api/user/{user_id} endpoint"""
import pytest
...
def test_ddt_get_valid_user(test_data: dict, application_client: Flask):
    """Test GET /api/user/{user_id} endpoint
