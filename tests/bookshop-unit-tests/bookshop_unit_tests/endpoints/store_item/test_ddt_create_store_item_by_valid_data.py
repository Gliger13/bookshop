"""Data Driven Unit Test to check POST /api/store-item endpoint"""
import pytest
...
def test_ddt_create_store_item_by_valid_data(test_data: dict, application_client: Flask):
    """Test POST /api/store-item endpoint
