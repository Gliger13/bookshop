"""Data Driven Unit Test to check DELETE /api/store-item/{store_item_id} endpoint"""
import pytest
...
def test_ddt_delete_valid_store_item(test_data: dict, application_client: Flask):
    """Test DELETE /api/store-item/{store_item_id} endpoint

    :param test_data: current test set data
    :param application_client: bookshop testing application
    """
    store_item_id_to_delete = test_data["store_item_id_to_delete"]
    endpoint = f"/api/store-item/{store_item_id_to_delete}"
