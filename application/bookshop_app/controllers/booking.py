...
from bookshop_app.services.authentication import (
    filter_bookings_by_roles,
    multi_auth,
    required_creating_booking_for_self_or_roles,
    required_own_given_booking_id_or_roles,
)
