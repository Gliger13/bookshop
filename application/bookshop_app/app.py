...
from bookshop_app.config import Config
from bookshop_app.config import get_environment_config_reference
from bookshop_app.database.database import db
from bookshop_app.dependencies import login_manager
from bookshop_app.dependencies import ma
from bookshop_app.routes.booking import booking_control
from bookshop_app.routes.booking import booking_manipulation
from bookshop_app.routes.product import product_control
from bookshop_app.routes.product import product_manipulation
from bookshop_app.routes.store_item import store_item_control
from bookshop_app.routes.store_item import store_item_manipulation
from bookshop_app.routes.user import user_control
from bookshop_app.routes.user import user_manipulation
